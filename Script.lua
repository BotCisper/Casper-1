...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(userid,msg.chat_id_).."")
else
...
Send_Options(msg,userid,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تقييده في المجموعه")  
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم مغادرة المجموعه") 
