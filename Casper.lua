...
io.write('\n\27[1;35m ‌‏𓂄‏ ‌‌𝄬 Send Token For Bot : ارسل توكن البوت ...\n\27[0;39;49m')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
io.write('\n\27[1;31m ‌‏𓂄‏ ‌‌𝄬 Token Is Communication Error\n التوكن غلط جرب مره اخره \n\27[0;39;49m')
else
io.write('\n\27[1;31m ‌‏𓂄‏ ‌‌𝄬 Done Save Token : تم حفظ التوكن \n\27[0;39;49m')
redis:set(Server_Casper.."Token_DevCasper",token)
end 
else
io.write('\n\27[1;31m ‌‏𓂄‏ ‌‌𝄬 Token was not saved \n لم يتم حفظ التوكن \n\27[0;39;49m')
end 
os.execute('lua Casper.lua')
end
------------------------------------------------------------------------------------------------------------
if not redis:get(Server_Casper.."User_DevCasper1") then
io.write('\n\27[1;35m ‌‏𓂄‏ ‌‌𝄬 Send ID For Sudo : ارسل ايدي المطور الاساسي ...\n\27[0;39;49m')
local User_Sudo = io.read():gsub('@','')
if User_Sudo ~= '' then
io.write('\n\27[1;31m ‌‏𓂄‏ ‌‌𝄬 The ID Is Saved : تم حفظ ايدي المطور\n\27[0;39;49m')
redis:set(Server_Casper.."Id_DevCasper",User_Sudo)
io.write('\n\27[1;35m ‌‏𓂄‏ ‌‌𝄬 Send UserName For Sudo : ارسل معرف المطور الاساسي ...\n\27[0;39;49m')
local User_Sudo2 = io.read():gsub('@','')
if User_Sudo ~= '' then
redis:set(Server_Casper.."User_DevCasper1",User_Sudo2)
end
else
io.write('\n\27[1;31m ‌‏𓂄‏ ‌‌𝄬 The ID was not Saved : لم يتم حفظ ايدي المطور الاساسي\n\27[0;39;49m')
end 
os.execute('lua Casper.lua')
end
------------------------------------------------------------------------------------------------------------
...
url = 'https://raw.githubusercontent.com/BotCasper/Casper/master/Script.lua'
...
url = 'https://raw.githubusercontent.com/BotCasper/Casper/master/Casper.lua'
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text.."")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
...
send(chat,idmsg," ‌‏𓂄‏ ‌‌𝄬 المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
else
send(chat,idmsg," ‌‏𓂄‏ ‌‌𝄬  لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
------------------------------------------------------------------------------------------------------------
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 قام بالتكرار هنا وتم طرده")  
...
Send_Options(msg,msg.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
send(chat,msg.id_,"* ‌‏𓂄‏ ‌‌𝄬 عذرا الملف ليس بصيغة ال : Json*")
return false
end
-- if tonumber(JsonFile:match('(%d+)')) ~= tonumber(bot_id) then 
-- send(chat,msg.id_," ‌‏𓂄‏ ‌‌𝄬 الملف لا يتوافق مع البوت يرجى رفع ملف نسخة الكروبات الحقيفي")   
-- return false 
-- end      
local File = json:decode(https.request('https://api.telegram.org/bot'..token..'/getfile?file_id='..File_id) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path,''..JsonFile) 
send(chat,msg.id_," ‌‏𓂄‏ ‌‌𝄬 جاري بدء رفع الكروبات وتحويل الخزن ...")   
...
send(msg.chat_id_, msg.id_,'\n ‌‏𓂄‏ ‌‌𝄬 الكانسر مقفول يرجى زغرفه اسمك اولاً\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n[ ‌‏𓂄‏ ‌‌𝄬  اضغط هنا لزغرفه اسمك.](https://t.me/SJAIBot)')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
end
end,nil)   
return false
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تغيير صورة المجموعه") 
end
end, nil) 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
if text == "الغاء" or text == "• الغاء × ." then   
send(msg.chat_id_,msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."ChekBotAdd")   
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
if text == "الغاء" or text == "• الغاء × ." then   
send(msg.chat_id_,msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 تم الغاء الاذاعه بالترجيه خاص") 
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حفظ الرابط بنجاح")       
redis:del(bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
if Text_Filter then    
Send_Options(msg,msg.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 "..Text_Filter)  
Delete_Message(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 تم اضافة الصلاحيه باسم ‌← { "..textn..' }') 
redis:del(bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 لقد فزت في اللعبه \n ‌‏𓂄‏ ‌‌𝄬 اللعب مره اخره وارسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 لقد فزت في اللعبه \n ‌‏𓂄‏ ‌‌𝄬 اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 مبروك فزت ويانه وخمنت الرقم الصحيح\n ‌‏𓂄‏ ‌‌𝄬 تم اضافة { 5 } من النقاط \n")
...
redis:del(bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اوبس لقد خسرت في اللعبه \n ‌‏𓂄‏ ‌‌𝄬 حظآ اوفر في المره القادمه \n ‌‏𓂄‏ ‌‌𝄬 كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اوبس تخمينك غلط \n ‌‏𓂄‏ ‌‌𝄬 ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n ‌‏𓂄‏ ‌‌𝄬 لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 للاسف لقد خسرت \n ‌‏𓂄‏ ‌‌𝄬 المحيبس بل ايد رقم { "..GETNUM.." }\n ‌‏𓂄‏ ‌‌𝄬 حاول مره اخرى للعثور على المحيبس")
end
end
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 لقد فزت في اللعبه \n ‌‏𓂄‏ ‌‌𝄬 اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم الغاء منعها ")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل التحذير عند ارسال الكلمه")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم منع الكلمه مع التحذير")  
redis:del(bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_,msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم الغاء حفظ كليشة المطور')
return false
end
redis:set(bot_id..'Texting:DevCasper',text)
redis:del(bot_id..'GetTexting:DevCasper'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم حفظ كليشة المطور')
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حفظ رد للمدير بنجاح \n ‌‏𓂄‏ ‌‌𝄬 ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '\n ‌‏𓂄‏ ‌‌𝄬 ارسل لي الرد لاضافته\n ‌‏𓂄‏ ‌‌𝄬 تستطيع اضافة ‌← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n ‌‏𓂄‏ ‌‌𝄬 تستطيع ايضا اضافة :\n ‌‏𓂄‏ ‌‌𝄬 `#username` » معرف المستخدم \n ‌‏𓂄‏ ‌‌𝄬 `#msgs` » عدد الرسائل\n ‌‏𓂄‏ ‌‌𝄬 `#name` » اسم المستخدم\n ‌‏𓂄‏ ‌‌𝄬 `#id` » ايدي المستخدم\n ‌‏𓂄‏ ‌‌𝄬 `#stast` » موقع المستخدم \n ‌‏𓂄‏ ‌‌𝄬 `#edit` » عدد السحكات ')
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حذف الرد من ردود المدير ")
redis:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حفظ رد للمطور \n ‌‏𓂄‏ ‌‌𝄬 ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حذف الرد من ردود المطور")
...
elseif text == "• تحديث البوت ᜱ ." then
dofile("Casper.lua")  
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم تحديث ملفات البوت")
elseif text == "تحديث" then
dofile("Casper.lua")  
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم تحديث ملفات البوت")
elseif text == '• تحديث السورس ᜱ .' then
download_to_file('https://raw.githubusercontent.com/BotCasper/Casper/master/Casper.lua','Casper.lua') 
download_to_file('https://raw.githubusercontent.com/BotCasper/Casper/master/Script.lua','Script.lua') 
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم تحديث السورس وتنزيل اخر تحديث للملفات")
...
if i == 0 then
Files = ' ‌‏𓂄‏ ‌‌𝄬  لا توجد ملفات في البوت '
end
...
if Get_info then
local TextS = "\n ‌‏𓂄‏ ‌‌𝄬 قائمه ملفات متجر سورس Casper\n ‌‏𓂄‏ ‌‌𝄬 الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
local TextE = "\n━━━━━━━━━━━━━\n ‌‏𓂄‏ ‌‌𝄬 علامة ‌← {✔} تعني الملف مفعل\n ‌‏𓂄‏ ‌‌𝄬 علامة ‌← {❌} تعني الملف معطل\n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  لا يوجد اتصال من ال api") 
end
elseif text == "مسح جميع الملفات" then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم مسح جميع ملفات المفعله")
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 الملف ‌← *"..File_Name.."*\n ‌‏𓂄‏ ‌‌𝄬 تم تعطيله وحذفه من البوت بنجاح") 
dofile('Casper.lua')  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لا يوجد ملف بهاذا الاسم") 
end
...
if Dev_Casper(msg) then
local Text_keyboard = '゠اهلا بيك عمري 💞⸼ .\n゠انت المطور الاساسي للبوت 𖧧.\n゠تستطيع التحكم باوامر البوت 𖧧.\n゠من خلال الكيبورد الخاص بك 𖧧.\n゠قناة السورس  ◝ @Cispar ◟ .'
local List_keyboard = {
{'• تغير اسم البوت 𖠹 .'},
{'• تفعيل التواصل  𖡩 .','• تعطيل التواصل  × .'},
{'• احصائيات البوت 𖡬 .'},
{'• تفعيل الاذاعه 𓃚 .','• تعطيل الاذاعه 𓃚 .'},
{'• اذاعة بالتثبيت 𖡮 .'},
{'• اذاعة خاص 𖡮 .','• اذاعة للمجموعات 𖡮 .'},
{'• اذاعة خاص بالتوجيه 𖣮 .','• اذاعة بالتوجية  𖣮 .'},
{'• قائمه العام 𖠐 .','• قائمه المطورين 𖠐 .'},
{'• مسح قائمه العام 𖤾 .','• مسح المطورين 𖤾 .'},
{'• تفعيل البوت خدمي 𖤴 .','• تعطيل البوت خدمي 𖤴 .'},
{'• تنظيف الكروبات 𖤸 .','• تنظيف المشتركيين 𖤸 .'},
{'• تفعيل مغادرة البوت 𖡩 .','• تعطيل مغادرة البوت × .'},
{'• حذف كليشة 𖡲 start  .','• تغير كليشة 𖡲 start  .'},
...
CmdStart = '\n ‌‏𓂄‏ ‌‌𝄬 أهلآ بك في بوت '..Name_Bot..''..
'\n ‌‏𓂄‏ ‌‌𝄬 اختصاص البوت حماية المجموعات'..
'\n ‌‏𓂄‏ ‌‌𝄬 لتفعيل البوت عليك اتباع مايلي ...'..
'\n ‌‏𓂄‏ ‌‌𝄬 اضف البوت الى مجموعتك'..
'\n ‌‏𓂄‏ ‌‌𝄬 ارفعه ادمن {مشرف}'..
'\n ‌‏𓂄‏ ‌‌𝄬 ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n ‌‏𓂄‏ ‌‌𝄬 سيتم ترقيتك منشئ اساسي في البوت'..
'\n ‌‏𓂄‏ ‌‌𝄬 مطور البوت ‌← {['..UserName_Dev..']}'
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv"," ‌‏𓂄‏ ‌‌𝄬 قام بارسال الملصق")  
return false
end
end
end,nil)
...
if text == 'حظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," ‌‏𓂄‏ ‌‌𝄬 تم حظره من تواصل البوت")  
redis:sadd(bot_id..'User:Ban:Pv',data.id_)  
return false  
elseif text =='الغاء الحظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره من تواصل البوت")  
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," ‌‏𓂄‏ ‌‌𝄬 قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv"," ‌‏𓂄‏ ‌‌𝄬 تم ارسال رسالتك اليه بنجاح")  
end,nil)end,nil)
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تفعيل مغادرة البوت") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تعطيل الاذاعه") 
elseif text == '• تفعيل البوت خدمي 𖤴 .' then  
redis:del(bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل البوت الخدمي \n ‌‏𓂄‏ ‌‌𝄬 الان يمكن الجميع تفعيله') 
elseif text == '• تعطيل البوت خدمي 𖤴 .' then  
redis:set(bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم تعطيل البوت الخدمي') 
elseif text == '• تغير كليشة المطور ⍅ .' then
redis:set(bot_id..'GetTexting:DevCasper'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,' ‌‏𓂄‏ ‌‌𝄬  ارسل لي الكليشه الان')
elseif text=="• اذاعة خاص 𖡮 ." then 
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي المنشور الان\n ‌‏𓂄‏ ‌‌𝄬 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n ‌‏𓂄‏ ‌‌𝄬 لالغاء الاذاعه ارسل : الغاء") 
return false
elseif text=="• اذاعة للمجموعات 𖡮 ." then 
redis:setex(bot_id.."Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي المنشور الان\n ‌‏𓂄‏ ‌‌𝄬 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n ‌‏𓂄‏ ‌‌𝄬 لالغاء الاذاعه ارسل : الغاء") 
return false
elseif text=="• اذاعة بالتثبيت 𖡮 ." and DeveloperBot(msg) then 
redis:setex(bot_id.."Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي المنشور الان\n ‌‏𓂄‏ ‌‌𝄬 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n ‌‏𓂄‏ ‌‌𝄬 لالغاء الاذاعه ارسل : الغاء") 
return false
elseif text=="• اذاعة بالتوجية  𖣮 ." and DeveloperBot(msg) then 
redis:setex(bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي التوجيه الان\n ‌‏𓂄‏ ‌‌𝄬 ليتم نشره في المجموعات") 
return false
elseif text=="• اذاعة خاص بالتوجيه 𖣮 ." and DeveloperBot(msg) then 
redis:setex(bot_id.."Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي التوجيه الان\n ‌‏𓂄‏ ‌‌𝄬 ليتم نشره الى المشتركين") 
return false
elseif text == '• حذف كليشة المطور ⍅ .' then
redis:del(bot_id..'Texting:DevCasper')
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  تم حذف كليشه المطور')
elseif text == "• تغير اسم البوت 𖠹 ." then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  ارسل لي الاسم الان ")  
return false
elseif text == ("• مسح قائمه العام 𖤾 .") or text == ("مسح المحظورين عام") then
redis:del(bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم مسح المحظورين عام من البوت")
elseif text == ("• مسح المطورين 𖤾 .") then
redis:del(bot_id.."Developer:Bot")
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المطورين من البوت  ")
elseif text == ("• قائمه العام 𖠐 .") or text == ("المحظورين عام") then
local list = redis:smembers(bot_id.."Removal:User:Groups")
Gban = "\n ‌‏𓂄‏ ‌‌𝄬 قائمة المحظورين عام في البوت\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرا هاذا معرف قناة")   
return false 
end      
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 لا تسطيع حظر البوت عام")
return false 
end
if Dev_Casper_User(result.id_) == true then
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 لا تستطيع حظر المطور الاساسي عام")
return false 
end
redis:sadd(bot_id.."Removal:User:Groups", result.id_)
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
function FunctionStatus(arg, result)
if (result.id_) then
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره عام من المجموعات")  
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مطور في البوت")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المطورين")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^حذف مطور @(.*)$")}, FunctionStatus, nil)
elseif text =='• احصائيات البوت 𖡬 .' then 
send(msg.chat_id_, msg.id_,'* ‌‏𓂄‏ ‌‌𝄬 عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n ‌‏𓂄‏ ‌‌𝄬 عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n ‌‏𓂄‏ ‌‌𝄬 عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'* ‌‏𓂄‏ ‌‌𝄬  تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text == 'حذف كليشه المطور' then
redis:del(bot_id..'Texting:DevCasper')
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  تم حذف كليشه المطور')
elseif text == "• تنظيف المشتركيين 𖤸 ." then
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'* ‌‏𓂄‏ ‌‌𝄬 عدد المشتركين الان ‌←{ '..#pv..' }\n ‌‏𓂄‏ ‌‌𝄬 تم العثور على ‌←{ '..sendok..' } مشترك قام بحظر البوت\n ‌‏𓂄‏ ‌‌𝄬 اصبح عدد المشتركين الان ‌←{ '..ok..' } مشترك *')   
end
end
end,nil)
end,nil)
...
return false
elseif text == "• تنظيف الكروبات 𖤸 ." then
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لا توجد مجموعات وهميه ')   
else
local taha = (w + q)
...
taha = '\n ‌‏𓂄‏ ‌‌𝄬  تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
Casper = ''
else
Casper = '\n ‌‏𓂄‏ ‌‌𝄬  تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'* ‌‏𓂄‏ ‌‌𝄬  عدد المجموعات الان ‌← { '..#group..' } مجموعه '..Casper..''..taha..'\n ‌‏𓂄‏ ‌‌𝄬 اصبح عدد المجموعات الان ‌← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
return false
elseif text == '• جلب النسخة الاحتياطية 𖥠 .' then
...
File:write(Get_Json)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./lib/'..bot_id..'.json', '\n ‌‏𓂄‏ ‌‌𝄬 تم جلب نسخه خاصه بالكروبات\n ‌‏𓂄‏ ‌‌𝄬 يحتوي الملف على {'..#Groups..'} مجموعه')
elseif text == '• تفعيل التواصل  𖡩 .' then  
redis:del(bot_id..'Status:Lock:Twasl') 
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  تم تفعيل التواصل ') 
elseif text == '• تعطيل التواصل  × .' then  
redis:set(bot_id..'Status:Lock:Twasl',true) 
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  تم تعطيل التواصل ') 
end
end 
end
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مطور في البوت")  
end
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
...
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرا اذا معرف قناة")   
return false 
end      
redis:sadd(bot_id.."Developer:Bot", result.id_)
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مطور في البوت")  
...
Send_Options(msg,text:match("^اضف مطور (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مطور في البوت")  
return false
end
...
Send_Options(msg,text:match("^حذف مطور (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المطورين")  
return false
end
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المنشئين الاساسيين في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المنشئين في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المدراء في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح الادمنيه في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المميزين في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  تم مسح المكتومين في المجموعه")
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم مسح المحظورين في المجموعه")
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم مسح جميع الاوامر التي تم اضافتها")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم مسح صلاحيات المجموعه")
...
data = JSON.decode(url)
if data.Ch_Member.Casper ~= true then
send(msg.chat_id_,msg.id_,'\n ‌‏𓂄‏ ‌‌𝄬 عليك الاشتراك في قناة البوت \n ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌← { @XOUXU }')   
return false 
end
local list = redis:smembers(bot_id.."Developer:Bot")
...
Asase = "\n ‌‏𓂄‏ ‌‌𝄬 قائمة المنشئين الاساسين في المجموعه\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
if username then
...
if #list == 0 then
Asase = " ‌‏𓂄‏ ‌‌𝄬 لا يوجد منشئين اساسيين"
end
...
if #list == 0 then
Bans = " ‌‏𓂄‏ ‌‌𝄬 لا يوجد محظورين"
end
send(msg.chat_id_, msg.id_, Bans)
elseif text == "الصلاحيات" and Admin(msg) then 
local list = redis:smembers(bot_id.."Validitys:Group"..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لا توجد صلاحيات مضافه هنا")
return false
end
Validity = "\n ‌‏𓂄‏ ‌‌𝄬 قائمة الصلاحيات المضافه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
local list = redis:smembers(bot_id.."Command:List:Group"..msg.chat_id_.."")
Command = " ‌‏𓂄‏ ‌‌𝄬 قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = " ‌‏𓂄‏ ‌‌𝄬 لا توجد اوامر اضافيه"
end
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره عام من المجموعات")  
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Admin:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مميز للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.sender_user_id_,msg.chat_id_).." ")
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لا توجد لدي صلاحية حظر المستخدمين") 
return false  
end
redis:sadd(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
function FunctionStatus(arg, result)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 لا يمكنك عمل هاذا الامر على البوت") 
return false 
end
redis:srem(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته : "..text:match("رفع (.*)").."")  
end   
...
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله : "..text:match("تنزيل (.*)").."")  
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, Status_reply, nil)
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم رفعه : "..text1[2].."")
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله : "..text1[2].."")
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط")
end
end
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.id_,msg.chat_id_).."")
else
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply", " ‌‏𓂄‏ ‌‌𝄬 تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
end
end
...
KickGroup(msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 المعرف غلط ")
...
Send_Options(msg,text:match("^حظر عام (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره عام من المجموعات")  
...
Send_Options(msg,text:match("^الغاء العام (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره عام من المجموعات")  
return false
end
...
Send_Options(msg,text:match("^رفع منشئ اساسي (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ اساسي")  
...
Send_Options(msg,text:match("^تنزيل منشئ اساسي (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع منشئ (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته منشئ في المجموعه")  
...
Send_Options(msg,text:match("^تنزيل منشئ (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع مدير (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مدير المجموعه")  
...
Send_Options(msg,text:match("^تنزيل مدير (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المدراء")  
...
Send_Options(msg,text:match("^رفع ادمن (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته ادمن للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل ادمن (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من ادمنيه المجموعه")  
...
Send_Options(msg,text:match("^رفع مميز (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم ترقيته مميز للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل مميز (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تنزيله من المميزين")  
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^حظر (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^حظر (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم حظره من المجموعه")  
end,nil)   
end
...
Send_Options(msg,text:match("^الغاء حظر (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء حظره من هنا")  
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^كتم (%d+)$"),msg.chat_id_).."")
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرآ البوت ليس ادمن") 
return false  
...
Send_Options(msg,text:match("^كتم (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم كتمه من هنا")  
end
...
Send_Options(msg,text:match("^الغاء كتم (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء كتمه من هنا")  
elseif text and text:match("^تقيد (%d+)$") and Admin(msg) then
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 عذرآ البوت ليس ادمن") 
return false  
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^تقيد (%d+)$"),msg.chat_id_).."")
else
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..text:match("^تقيد (%d+)$"))
Send_Options(msg,text:match("^تقيد (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم تقييده في المجموعه")  
end
...
Send_Options(msg,result.sender_user_id_,"reply", " ‌‏𓂄‏ ‌‌𝄬 تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,text:match("^الغاء تقيد (%d+)$"),"reply"," ‌‏𓂄‏ ‌‌𝄬 تم الغاء تقييده")  
...
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^طرد (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^طرد (%d+)$") ,"reply"," ‌‏𓂄‏ ‌‌𝄬 تم طرده من هنا")  
end,nil)   
end
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل الفارسيه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل الفشار")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل الدردشه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل اضافة الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل دخول الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل تعديل")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status"," ‌‏𓂄‏ ‌‌𝄬 تم قفـل جميع الاوامر")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status"," ‌‏𓂄‏ ‌‌𝄬 تم فتح البوتات")  
elseif text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Admin(msg) then 
redis:del(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_)  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status"," ‌‏𓂄‏ ‌‌𝄬 تم فتح الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status"," ‌‏𓂄‏ ‌‌𝄬 تم فتح التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status"," ‌‏𓂄‏ ‌‌𝄬 تم فتح تعديل")  
...
redis:set(bot_id.."Status:Lock:edit"..msg.chat_id_,true) 
redis:set(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"kick")  
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تفعيل الحمايه القصوى") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تعطيل امر اطردني") 
...
redis:set(bot_id.."Status:Lock:Ban:Group"..msg.chat_id_,"true")
send(msg.chat_id_, msg.id_, ' ‌‏𓂄‏ ‌‌𝄬 تم تعطيل - ( الحظر - الطرد ) ')
...
send(msg.chat_id_, msg.id_, ' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل - ( الحظر - الطرد ) ')
elseif text == "تعطيل الرفع" and Constructor(msg) or text == "تعطيل الترقيه" and Constructor(msg) then
redis:set(bot_id.."Status:Cheking:Seted"..msg.chat_id_,"true")
send(msg.chat_id_, msg.id_, ' ‌‏𓂄‏ ‌‌𝄬 تم تعطيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_, msg.id_, ' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 التثبيت مقفل من قبل المنشئين")  
return false end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تثبيت الرساله بنجاح")   
redis:set(bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 البوت ليس ادمن هنا")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ليست لدي صلاحية التثبيت .")  
end;end,nil) 
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم الغاء تثبيت الرساله بنجاح")   
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم طرد الحسابات المحذوفه')
end,nil)
end
elseif text ==("مسح المطرودين") and Admin(msg) then    
local function delbans(extra, result)  
if not msg.can_be_deleted_ == true then  
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬  يرجى ترقيتي ادمن هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم الغاء الحظر عن *: "..num.." * شخص") 
end    
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 لا توجد بوتات في المجموعه")
else
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 عدد البوتات هنا : "..c.."\n ‌‏𓂄‏ ‌‌𝄬 عدد البوتات التي هي ادمن : "..x.."\n ‌‏𓂄‏ ‌‌𝄬 تم طرد - "..(c - x).." - بوتات ") 
end 
end,nil)  
elseif text == "مسح الرابط" and Admin(msg) or text == "حذف الرابط" and Admin(msg) then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة رابط المجموعه")           
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة صورة المجموعه") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة ترحيب المجموعه") 
elseif text == "مسح القوانين" and Admin(msg) or text == "حذف القوانين" and Admin(msg) then  
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_, ' ‌‏𓂄‏ ‌‌𝄬 تم ازالة كليشة الايدي ')
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم مسح جميع رسائلك ') 
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم مسح جميع تعديلاتك ') 
elseif text == 'مسح جهاتي' then
redis:del(bot_id..'Num:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم مسح جميع جهاتك المضافه ') 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم وضع عدد التكرار : "..text:match("^وضع تكرار (%d+)$").."")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم وضع زمن التكرار : "..text:match("^وضع زمن التكرار (%d+)$").."") 
elseif text == "ضع رابط" and Admin(msg) or text == "وضع رابط" and Admin(msg) then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل رابط المجموعه او رابط قناة المجموعه")
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الصوره لوضعها") 
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الوصف")
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي الترحيب الان".."\n ‌‏𓂄‏ ‌‌𝄬 تستطيع اضافة مايلي !\n ‌‏𓂄‏ ‌‌𝄬 دالة عرض الاسم »{`name`}\n ‌‏𓂄‏ ‌‌𝄬 دالة عرض المعرف »{`user`}") 
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي القوانين الان")  
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬  البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬  ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
elseif text == 'روابط الكروبات' and Dev_Casper(msg) then
local list = redis:smembers(bot_id..'ChekBotAdd') 
test = ' ‌‏𓂄‏ ‌‌𝄬 روابط الكروبات \n\n'
for k,v in pairs(list) do 
...
if status_Link then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 جلب الرابط معطل") 
return false  
end
local link = redis:get(bot_id.."Status:link:set:Group"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 𝘭𝘪𝘯𝘬 𝘨𝘳𝘰𝘶𝘱 :\n ["..link.."]\n••━━━━━━━━━━━━••")
else                
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لا يوجد رابط للمجموعه")              
end            
end
...
Welcome = " ‌‏𓂄‏ ‌‌𝄬 لم يتم تعيين ترحيب للمجموعه"
end 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم مسح قائمه المنع")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الكلمه الان")  
...
if #admins == i then 
local a = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n ‌‏𓂄‏ ‌‌𝄬 عدد البوتات التي هنا : "..n.." بوت"
local f = "\n ‌‏𓂄‏ ‌‌𝄬 عدد البوتات التي هي ادمن : "..t.."\n ‌‏𓂄‏ ‌‌𝄬 ملاحضه علامة النجمه يعني البوت ادمن - ★ \n"
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬 ارسل نوع الصلاحيه كما مطلوب منك :\n ‌‏𓂄‏ ‌‌𝄬 انواع الصلاحيات المطلوبه ‌← { عضو ، مميز  ، ادمن  ، مدير }") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم تغير رد المطور الى :"..Teext)
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم تغير رد المنشئ الاساسي الى :"..Teext)
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم تغير رد المنشئ الى :"..Teext)
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم مسح قائمه ردود المدير")
elseif text == ("ردود المدير") and Owner(msg) then
local list = redis:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = " ‌‏𓂄‏ ‌‌𝄬 قائمه ردود المدير \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if #list == 0 then
text = " ‌‏𓂄‏ ‌‌𝄬 عذرا لا يوجد ردود للمدير في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الكلمه لاضافتها في ردود المدير ")
redis:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الكلمه لحذفها من ردود المدير")
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حذف ردود المطور")
...
if #list == 0 then
text = " ‌‏𓂄‏ ‌‌𝄬 لا توجد ردود للمطور"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_Casper(msg) then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الكلمه لاضافتها في ردود المكور ")
redis:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد للكل" and Dev_Casper(msg) then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الان الكلمه لحذفها من ردود المطور")
...
if (result.id_) then
if Dev_Casper_User(result.id_) == true then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 تم تنزيل الشخص من الرتب التاليه \n ‌‏𓂄‏ ‌‌𝄬  { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 ليس لديه رتب حتى استطيع تنزيله \n")
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  رتبتك في البوت : "..rtp)
elseif text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = " ‌‏𓂄‏ ‌‌𝄬  اسمك الاول : `"..(result.first_name_).."`"
else
first_name = ""
end   
if result.last_name_ then 
last_name = " ‌‏𓂄‏ ‌‌𝄬  اسمك الثاني ‌← : `"..result.last_name_.."`" 
else
last_name = ""
end      
...
local taha = " ‌‏𓂄‏ ‌‌𝄬  عدد الادمنيه : "..data.administrator_count_..
"\n ‌‏𓂄‏ ‌‌𝄬  عدد المطرودين : "..data.kicked_count_..
"\n ‌‏𓂄‏ ‌‌𝄬  عدد الاعضاء : "..data.member_count_..
"\n ‌‏𓂄‏ ‌‌𝄬  عدد رسائل الكروب : "..(msg.id_/2097152/0.5)..
"\n ‌‏𓂄‏ ‌‌𝄬  اسم المجموعه : ["..ta.title_.."]"
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حبيبي حغادر") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حبيبي حغادر") 
send(GP_ID[2], 0," ‌‏𓂄‏ ‌‌𝄬  تم مغادرة المجموعه بامر من مطور البوت") 
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل لي المنشور الان\n ‌‏𓂄‏ ‌‌𝄬 يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n ‌‏𓂄‏ ‌‌𝄬 لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"*\n ‌‏𓂄‏ ‌‌𝄬 اعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n ‌‏𓂄‏ ‌‌𝄬 علامة ال (✔️) تعني مفعل"..
"\n ‌‏𓂄‏ ‌‌𝄬 علامة ال (✖) تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n ‌‏𓂄‏ ‌‌𝄬 الروابط "..lock_links..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الكلايش "..lock_spam..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الكيبورد "..lock_inlin..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الاغاني "..lock_vico..
"\n".." ‌‏𓂄‏ ‌‌𝄬 المتحركه "..lock_gif..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الملفات "..lock_file..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الدردشه "..lock_text..
...
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n".." ‌‏𓂄‏ ‌‌𝄬 التثبيت "..lock_pin..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الاشعارات "..lock_tagservr..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الماركدون "..lock_mark..
"\n".." ‌‏𓂄‏ ‌‌𝄬 التعديل "..lock_edit..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الالعاب "..lock_geam..
"\n".." ‌‏𓂄‏ ‌‌𝄬 التكرار "..flood..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
...
"\n".." ‌‏𓂄‏ ‌‌𝄬 الطرد "..Banusers..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الايدي "..IdPhoto..
"\n".." ‌‏𓂄‏ ‌‌𝄬 الايدي بالصوره "..IdPyPhoto..
"\n".." ‌‏𓂄‏ ‌‌𝄬 اطردني "..KickMe..
"\n".." ‌‏𓂄‏ ‌‌𝄬 ردود المدير "..ReplyManager..
"\n".." ‌‏𓂄‏ ‌‌𝄬 ردود المطور "..ReplySudo..
"\n".." ‌‏𓂄‏ ‌‌𝄬 اوامر التحشيش "..FunGroup..
"\n".." ‌‏𓂄‏ ‌‌𝄬 جلب الرابط "..Link_Group..
"\n".." ‌‏𓂄‏ ‌‌𝄬 عدد التكرار ‌← {"..Num_Flood.."}\n\n.*")     
elseif text == 'تعين الايدي' and Owner(msg) then
redis:setex(bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
 ‌‏𓂄‏ ‌‌𝄬 ارسل الان النص
 ‌‏𓂄‏ ‌‌𝄬 يمكنك اضافه :
 ‌‏𓂄‏ ‌‌𝄬 `#username` » اسم المستخدم
 ‌‏𓂄‏ ‌‌𝄬 `#msgs` » عدد الرسائل
 ‌‏𓂄‏ ‌‌𝄬 `#photos` » عدد الصور
 ‌‏𓂄‏ ‌‌𝄬 `#id` » ايدي المستخدم
 ‌‏𓂄‏ ‌‌𝄬 `#auto` » نسبة التفاعل
 ‌‏𓂄‏ ‌‌𝄬 `#stast` » رتبة المستخدم 
 ‌‏𓂄‏ ‌‌𝄬 `#edit` » عدد السحكات
 ‌‏𓂄‏ ‌‌𝄬 `#game` » عدد المجوهرات
 ‌‏𓂄‏ ‌‌𝄬 `#AddMem` » عدد الجهات
 ‌‏𓂄‏ ‌‌𝄬 `#Description` » تعليق الصوره
 ‌‏𓂄‏ ‌‌𝄬  قناة الكلايش • @Gverr
]])
return false  
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  تم تغير الايدي ارسل ايدي لرؤيته')
end
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تستطيع حذف *(1000)* رساله فقط') 
return false  
end  
lk_keko = {[0]=msg.id_}
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم ازالة *- '..Msg_Num..'* رساله من المجموعه')  
elseif text and (text == "تنظيف جميع الميديا" or text == "تنظيف الميديا") and Admin(msg) then   
    ...
    send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة 100 من وسائط 🛡") 
elseif text and (text == "تنظيف جميع الرسائل المعدله" or text == "تنظيف الرسائل المعدلة" or text == "تنظيف الرسائل المعدله") and Admin(msg) then   
    ...
    send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم ازالة 100 رساله معدلة 🛡') 
...
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
send(msg.chat_id_, msg.id_,'\n* ‌‏𓂄‏ ‌‌𝄬 ايديه ‌← '..Id..'\n ‌‏𓂄‏ ‌‌𝄬 رسائله ‌← '..NumMsg..'\n ‌‏𓂄‏ ‌‌𝄬 معرفه ‌← *['..UserName_User..']*\n ‌‏𓂄‏ ‌‌𝄬 تفاعله ‌← '..TotalMsg..'\n ‌‏𓂄‏ ‌‌𝄬 رتبته ‌← '..Status_Gps..'\n ‌‏𓂄‏ ‌‌𝄬 تعديلاته ‌← '..NumMessageEdit..'\n ‌‏𓂄‏ ‌‌𝄬 جهاته ‌← '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يرتبها ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يحل الحزوره ↓\n {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يدز العكس ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"\n ‌‏𓂄‏ ‌‌𝄬 اهلا بك عزيزي في لعبة التخمين :\nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".." ‌‏𓂄‏ ‌‌𝄬 ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".." ‌‏𓂄‏ ‌‌𝄬 سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
 ‌‏𓂄‏ ‌‌𝄬 اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 ‌‏𓂄‏ ‌‌𝄬 الفائز يحصل على { 3 } من النقاط *
]])
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"??","??📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يدز الاختلاف ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 اسرع واحد يكمل المثل ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 توجد ‌← 5 اوامر في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 ارسل { م1 } ‌← اوامر الحمايه
 ‌‏𓂄‏ ‌‌𝄬 ارسل { م2 } ‌← اوامر الادمنيه
 ‌‏𓂄‏ ‌‌𝄬 ارسل { م3 } ‌← اوامر المدراء
 ‌‏𓂄‏ ‌‌𝄬 ارسل { م4 } ‌← اوامر المنشئين
 ‌‏𓂄‏ ‌‌𝄬 ارسل { م5 } ‌← اوامر مطورين البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌←* @XOUXU
]]) 
elseif text == 'م1' and Admin(msg) then
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 اوامر الحمايه اتبع مايلي ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قفل ، فتح ‌← الامر 
 ‌‏𓂄‏ ‌‌𝄬 تستطيع قفل حمايه كما يلي ...
 ‌‏𓂄‏ ‌‌𝄬 ‌← { بالتقيد ، بالطرد ، بالكتم }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 الروابط
 ‌‏𓂄‏ ‌‌𝄬 المعرف
 ‌‏𓂄‏ ‌‌𝄬 التاك
...
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 اوامر ادمنية المجموعه ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 رفع، تنزيل ‌← مميز
 ‌‏𓂄‏ ‌‌𝄬 تاك للكل ، عدد الكروب
 ‌‏𓂄‏ ‌‌𝄬 كتم ، حظر ، طرد ، تقيد
 ‌‏𓂄‏ ‌‌𝄬 الغاء كتم ، الغاء حظر ، الغاء تقيد
 ‌‏𓂄‏ ‌‌𝄬 منع ، الغاء منع 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 عرض القوائم كما يلي ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 المكتومين
 ‌‏𓂄‏ ‌‌𝄬 المميزين 
 ‌‏𓂄‏ ‌‌𝄬 قائمه المنع
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ...
 ‌‏𓂄‏ ‌‌𝄬 الرابط ، الاعدادات
 ‌‏𓂄‏ ‌‌𝄬 الترحيب ، القوانين
 ‌‏𓂄‏ ‌‌𝄬 تفعيل ، تعطيل ‌← الترحيب
 ‌‏𓂄‏ ‌‌𝄬 تفعيل ، تعطيل ‌← الرابط
 ‌‏𓂄‏ ‌‌𝄬 اضف صلاحيه ، مسح صلاحيه 
 ‌‏𓂄‏ ‌‌𝄬 جهاتي ،ايدي ، رسائلي
 ‌‏𓂄‏ ‌‌𝄬 سحكاتي ، مجوهراتي
 ‌‏𓂄‏ ‌‌𝄬 كشف البوتات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 وضع ، ضع ‌← الاوامر التاليه 
 ‌‏𓂄‏ ‌‌𝄬 اسم ، رابط ، صوره
 ‌‏𓂄‏ ‌‌𝄬 قوانين ، وصف ، ترحيب
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 حذف ، مسح ‌← الاوامر التاليه
 ‌‏𓂄‏ ‌‌𝄬 قائمه المنع ، المحظورين 
 ‌‏𓂄‏ ‌‌𝄬 المميزين ، المكتومين ، القوانين
 ‌‏𓂄‏ ‌‌𝄬 المطرودين ، البوتات ، الصوره
 ‌‏𓂄‏ ‌‌𝄬 الصلاحيات ، الرابط
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌←* @XOUXU
]]) 
...
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 اوامر المدراء في المجموعه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 رفع ، تنزيل ‌← ادمن
 ‌‏𓂄‏ ‌‌𝄬 الادمنيه 
 ‌‏𓂄‏ ‌‌𝄬 رفع، كشف ‌← القيود
 ‌‏𓂄‏ ‌‌𝄬 تنزيل الكل ‌← { بالرد ، بالمعرف }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 لتغيير رد الرتب في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 تغير رد ‌← {اسم الرتبه والنص} 
 ‌‏𓂄‏ ‌‌𝄬 المطور ، المنشئ الاساسي
 ‌‏𓂄‏ ‌‌𝄬 المنشئ ، المدير ، الادمن
 ‌‏𓂄‏ ‌‌𝄬 المميز ، العضو
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 تفعيل ، تعطيل ‌← الاوامر التاليه ↓
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 الايدي ، الايدي بالصوره
 ‌‏𓂄‏ ‌‌𝄬 ردود المطور ، ردود المدير
 ‌‏𓂄‏ ‌‌𝄬 اطردني ، الالعاب ، الرفع
 ‌‏𓂄‏ ‌‌𝄬 الحظر ، الرابط ، اوامر التحشيش
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 تعين ، مسح ‌←{ الايدي }
 ‌‏𓂄‏ ‌‌𝄬 رفع الادمنيه ، مسح الادمنيه
 ‌‏𓂄‏ ‌‌𝄬 ردود المدير ، مسح ردود المدير
 ‌‏𓂄‏ ‌‌𝄬 اضف ، حذف ‌← { رد }
 ‌‏𓂄‏ ‌‌𝄬 تنظيف ‌← { عدد }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌←* @XOUXU
...
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 اوامر المنشئ الاساسي
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 رفع ، تنزيل ‌←{ منشئ }
 ‌‏𓂄‏ ‌‌𝄬 المنشئين ، مسح المنشئين
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 اوامر المنشئ المجموعه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 رفع ، تنزيل ‌← { مدير }
 ‌‏𓂄‏ ‌‌𝄬 المدراء ، مسح المدراء
 ‌‏𓂄‏ ‌‌𝄬 اضف رسائل ‌← { بالرد او الايدي }
 ‌‏𓂄‏ ‌‌𝄬 اضف مجوهرات ‌← { بالرد او الايدي }
 ‌‏𓂄‏ ‌‌𝄬 اضف ، حذف ‌← { امر }
 ‌‏𓂄‏ ‌‌𝄬 الاوامر المضافه ، مسح الاوامر المضافه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌←* @XOUXU
]]) 
elseif text == 'م5' and DeveloperBot(msg)  then
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 اوامر المطور الاساسي  
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 حظر عام ، الغاء العام
 ‌‏𓂄‏ ‌‌𝄬 اضف ، حذف ‌← { مطور } 
 ‌‏𓂄‏ ‌‌𝄬 قائمه العام ، مسح قائمه العام
 ‌‏𓂄‏ ‌‌𝄬 المطورين ، مسح المطورين
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 اضف ، حذف ‌← { رد للكل }
 ‌‏𓂄‏ ‌‌𝄬 وضع ، حذف ‌← { كليشه المطور } 
 ‌‏𓂄‏ ‌‌𝄬 مسح ردود المطور ، ردود المطور 
 ‌‏𓂄‏ ‌‌𝄬 تحديث ،  تحديث السورس 
 ‌‏𓂄‏ ‌‌𝄬 تعين عدد الاعضاء ‌← { العدد }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 تفعيل ، تعطيل ‌← { الاوامر التاليه ↓}
 ‌‏𓂄‏ ‌‌𝄬 البوت الخدمي ، المغادرة ، الاذاعه
 ‌‏𓂄‏ ‌‌𝄬 ملف ‌← { اسم الملف }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 مسح جميع الملفات 
 ‌‏𓂄‏ ‌‌𝄬 المتجر ، الملفات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 اوامر المطور في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 تفعيل ، تعطيل ، الاحصائيات
 ‌‏𓂄‏ ‌‌𝄬 رفع، تنزيل ‌← { منشئ اساسي }
 ‌‏𓂄‏ ‌‌𝄬 مسح الاساسين ، المنشئين الاساسين 
 ‌‏𓂄‏ ‌‌𝄬 غادر ، غادر ‌← { والايدي }
 ‌‏𓂄‏ ‌‌𝄬 اذاعه ، اذاعه بالتوجيه ، اذاعه بالتثبيت
 ‌‏𓂄‏ ‌‌𝄬 اذاعه خاص ، اذاعه خاص بالتوجيه 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 قناة البوت ‌←* @XOUXU
]]) 
elseif text == 'الالعاب' then
send(msg.chat_id_, msg.id_,[[*
 ‌‏𓂄‏ ‌‌𝄬 قائمه الالعاب البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 لعبة المختلف » المختلف
 ‌‏𓂄‏ ‌‌𝄬 لعبة الامثله » امثله
 ‌‏𓂄‏ ‌‌𝄬 لعبة العكس » العكس
 ‌‏𓂄‏ ‌‌𝄬 لعبة الحزوره » حزوره
 ‌‏𓂄‏ ‌‌𝄬 لعبة المعاني » معاني
 ‌‏𓂄‏ ‌‌𝄬 لعبة البات » بات
 ‌‏𓂄‏ ‌‌𝄬 لعبة التخمين » خمن
 ‌‏𓂄‏ ‌‌𝄬 لعبه الاسرع » الاسرع
 ‌‏𓂄‏ ‌‌𝄬 لعبة السمايلات » سمايلات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ‌‏𓂄‏ ‌‌𝄬 مجوهراتي ‌← لعرض عدد الارباح
 ‌‏𓂄‏ ‌‌𝄬 بيع مجوهراتي ‌← { العدد } ‌← لبيع كل مجوهره مقابل {50} رساله
*]]) 
elseif text == 'رسائلي' then
local NumMsgg1 = redis:get(bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local nummsg = redis:get(bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 1 
local NumMsg = (NumMsgg1 + nummsg)
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 عدد رسائلك هنا *~ '..NumMsg..'*') 
...
send(msg.chat_id_,msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم خصم *~ { "..NUMPY.." }* من مجوهراتك \n ‌‏𓂄‏ ‌‌𝄬 وتم اضافة* ~ { "..(NUMPY * 50).." } رساله الى رسالك *")
end 
return false 
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 ارسل لي عدد الرسائل الان") 
return false
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 ارسل لي عدد المجوهرات الان") 
elseif text and text:match("^اضف مجوهرات (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف مجوهرات (%d+)$"))  
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم اضافه عدد مجوهرات : "..text:match("^اضف مجوهرات (%d+)$").." ")  
end
...
send(msg.chat_id_, msg.id_, " ‌‏𓂄‏ ‌‌𝄬 تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
...
send(msg.chat_id_, msg.id_, "\n ‌‏𓂄‏ ‌‌𝄬  عذرا لا استطيع طرد ( "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." )")
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تم طردك من المجموعه ") 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  امر اطردني تم تعطيله من قبل المدراء ") 
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  الحظر العام ‌← "..GBan.."\n ‌‏𓂄‏ ‌‌𝄬  الحظر ‌← "..Ban.."\n ‌‏𓂄‏ ‌‌𝄬  الكتم ‌← "..Muted)
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  المعرف غلط")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  لا توجد ادمنية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  تمت ترقية - "..num2.." من ادمنية المجموعه") 
end
end,nil)   
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬  حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "Cispar")
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
local UserName = (b.username_ or "Cispar")
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ترقية منشئ المجموعه ‌← ["..b.first_name_.."](T.me/"..UserName..")")  
...
if TypeForChat ~= 'ForSuppur' then
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬  يجب تحويل المجموعة الى خارقة. او وضع معرف للمجموعه لتصبح عامه ثم ارفع البوت وارسل تفعيل⚙️') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 البوت ليس ادمن يرجى ترقيتي !') 
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if redis:sismember(bot_id..'ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل المجموعه مسبقا')
else
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
...
Send_Options(msg,result.id_,'reply_Add',' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل مجموعه '..chat.title_..'')
...
sendText(Id_Dev,' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل مجموعه جديده\n'..'\n ‌‏𓂄‏ ‌‌𝄬 بواسطة : '..Name..''..'\n ‌‏𓂄‏ ‌‌𝄬 ايدي المجموعه : `'..IdChat..'`'..'\n ‌‏𓂄‏ ‌‌𝄬 عدد اعضاء المجموعه *: '..NumMember..'*'..'\n ‌‏𓂄‏ ‌‌𝄬 اسم المجموعه : ['..NameChat..']'..'\n ‌‏𓂄‏ ‌‌𝄬 الرابط : ['..LinkGp..']',0,'md')
end
end
end,nil) 
end,nil) 
...
send(msg.chat_id_, msg.id_,' ‌‏𓂄‏ ‌‌𝄬 المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add',' ‌‏𓂄‏ ‌‌𝄬 تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'ChekBotAdd',msg.chat_id_)  
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub('"',"") 
...
if not Dev_Casper(msg) then
sendText(Id_Dev,' ‌‏𓂄‏ ‌‌𝄬 تم تعطيل مجموعه جديده\n'..'\n ‌‏𓂄‏ ‌‌𝄬 بواسطة : '..Name..''..'\n ‌‏𓂄‏ ‌‌𝄬 ايدي المجموعه : `'..IdChat..'`\n ‌‏𓂄‏ ‌‌𝄬 اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
Send_Options(msg,msg.sender_user_id_,'reply_Add',' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل مجموعه '..chat.title_..'')
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
local NameChat = NameChat:gsub("}","") 
if not Dev_Casper(msg) then
sendText(Id_Dev,' ‌‏𓂄‏ ‌‌𝄬 تم تفعيل مجموعه جديده\n ‌‏𓂄‏ ‌‌𝄬 بواسطة : '..Name..'\n ‌‏𓂄‏ ‌‌𝄬 موقعه في المجموعه : '..Status_Rt..'\n ‌‏𓂄‏ ‌‌𝄬 ايدي المجموعه : `'..msg.chat_id_..'`\n ‌‏𓂄‏ ‌‌𝄬 عدد اعضاء المجموعه *: '..NumMember..'*\n ‌‏𓂄‏ ‌‌𝄬 اسم المجموعه : ['..NameChat..']\n ‌‏𓂄‏ ‌‌𝄬 الرابط : ['..LinkChat..']',0,'md')
end
end
end
end,nil)   
...
if (data.message_.content_.text_) then 
    if (ban_Keko["ban"..msg.chat_id_..msg.sender_user_id_] and ban_Keko["ban"..msg.chat_id_..msg.sender_user_id_] == data.message_.content_.text_ and ban_Keko["ban:count:"..msg.chat_id_..msg.sender_user_id_] and ban_Keko["ban:count:"..msg.chat_id_..msg.sender_user_id_] >= 3) then 
        if (ban_Keko["ban2:"..msg.chat_id_..msg.sender_user_id_]) then 
            ...
            send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لتلح يا حلو 😉")  
        end 
        return false
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم ازالة هاذا ‌← { "..text.." }")  
else
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 لا يوجد امر بهاذا الاسم")  
end
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_," ‌‏𓂄‏ ‌‌𝄬 تم حفظ الامر باسم ‌← { "..text..' }')  
...
if #list == 0 then
Send_Options(result,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 قام بالتعديل على الميديا")  
else
tt = "\n ‌‏𓂄‏ ‌‌𝄬 يا منشئين\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
...
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
Send_Options(result,result.sender_user_id_,"reply"," ‌‏𓂄‏ ‌‌𝄬 "..Text_Filter)  
return false
end
end
end
